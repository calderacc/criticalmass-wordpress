...
Die Daten erhält das Plugin von der Webseite https://criticalmass.in/. Es fragt die dortige Api nach aktuellen Tour- und Städtedaten ab. Der Zugriff auf die Api ist selbstverständlich kostenlos und unbeschränkt, du brauchst dafür keine speziellen Zugangsdaten. Um die Ladezeit deines Blogs zu verbessern, werden die abgefragten Daten gecachet, um unnötige Api-Anfragen zu vermeiden.
...
Bei den Werten für diese Parameter handelt es sich um so genannte Slugs, die du bei https://criticalmass.in/ aus der URL einer Stadt oder aus dem Verzeichnis (https://criticalmass.in/world) ablesen kannst.
...
- date-format: Steuert die Formatierung der Datumsangabe mit der date-Funktion von PHP. (Standardwert: d.m.Y H:i)
